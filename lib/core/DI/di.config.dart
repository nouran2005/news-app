...
import '../../features/category_details/data/data_source/data_category_imp/CategoriesDaoApiImp.dart'
    as _i256;
import '../../features/category_details/data/repositories/CategoryRepoImp.dart'
    as _i93;
import '../../features/category_details/domain/repositories/SourceRepo.dart'
    as _i86;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i86.CategoryRepo>(
        () => _i93.CategoryRepoImp(gh<_i172.CategoriesDao>()));
    gh.factory<_i661.SourceUseCase>(
        () => _i661.SourceUseCase(gh<_i86.CategoryRepo>()));
    gh.factory<_i377.CategoryCubit>(
        () => _i377.CategoryCubit(gh<_i661.SourceUseCase>()));
    return this;
  }
}
